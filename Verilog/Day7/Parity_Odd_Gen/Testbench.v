module parity_odd_gen_tb;

  reg a, b, c; // Declare input registers a, b, c
  wire z;      // Declare output wire z
  
  parity_odd_gen pg(.a(a), .b(b), .c(c), .z(z)); // Instantiate the module parity_odd_gen and connect its ports
  ...
  initial begin 
    ...
    $dumpfile("parity_odd_gen.vcd");
    $dumpvars(0, parity_odd_gen_tb);
  end
